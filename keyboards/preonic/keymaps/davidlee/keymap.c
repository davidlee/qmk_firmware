...
[_RAISE] = LAYOUT_preonic_grid(
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
  _______, KC_GRV, KC_ASTR,  KC_CIRC, KC_DQUO, KC_HOME, KC_PGUP, KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC, _______,   
  _______, KC_DLR, KC_AT,    KC_HASH, KC_EXLM, KC_QUES, KC_MDASH,KC_MINS, KC_EQL,  KC_LCBR, KC_RCBR, _______, 
  _______, KC_TILD,KC_PERC,  KC_AMPR, KC_COLN, KC_END,  KC_PGDN, KC_UNDS, KC_PLUS, KC_PIPE, KC_BSLS, _______, 
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______  
),
