 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |RecStp|      |REC M1|REC M2|      |  SPC |  HOME| PGDN | PGUP | END  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_NAV] = LAYOUT_preonic_grid(
  ...
  _______, DM_RSTP, _______, DM_REC1, DM_REC2, _______, KC_SPACE,KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  K_RESET, _______, _______, _______, _______, _______, MINMASK, _______, _______, _______, _______, _______, 
