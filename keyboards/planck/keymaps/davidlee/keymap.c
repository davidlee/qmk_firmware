...
[_MOD_L] = LAYOUT_planck_grid(
  ...
  _______, _______, _______, PASTE,   _______, _______, _______, _______, _______, _______, _______, _______
),
[_MOD_R] = LAYOUT_planck_grid(
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, DT_DOWN, DT_UP,   DT_PRNT, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
