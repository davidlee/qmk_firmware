...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_CMK] = LAYOUT(
// COLEMAK
KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    OS_ON,
...
_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  ...
  [_NAV] = LAYOUT(
_______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
KC_TAB,  _______, _______, _______, _______, _______,                   KC_WH_U, CMD_LBRC,CMD_MINS,CMD_EQL, CMD_RBRC,KC_WH_U,
KC_ESC,  KC_LCTL, KC_LOPT, KC_LCMD, KC_LSFT, _______,                   KC_BSPC, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_DEL,
KC_CAPS, UNDO,    CUT,     COPY,    PASTE,   PASTE,   _______, _______, KC_WH_D, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_WH_D,
...
CAP_WRD, KC_BSLS, KC_LBRC, KC_RBRC, KC_MINS, KC_EQL,  _______, _______, KC_COLN, KC_1,    KC_2,    KC_3,    KC_SLSH, KC_ENT,
                           KC_PLUS, EM_DASH, _______, _______, KC_0,    _______, KC_DOT,  _______
  ),
...
KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    _______, _______, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
  ...
  [_PTR] = LAYOUT(
_______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
KC_TAB,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   KC_WH_U, KC_BTN1, KC_BTN2, KC_BTN3, _______, KC_WH_U,
